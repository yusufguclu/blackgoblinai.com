    ...
    <main className="flex-grow pt-24 pb-8 md:pt-32 md:pb-12 flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-primary-container to-surface min-h-[calc(100vh-4rem)]">
      ...
      <div className="w-[calc(100%-2rem)] max-w-md mx-auto bg-surface-dim border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative z-10 flex flex-col">
        ...
        <div className="p-6 md:p-8 flex flex-col space-y-6">
          ...
          {successMessage && (
            <div className="bg-tertiary text-white font-bold px-4 py-2 border-2 border-black uppercase text-sm text-center">
              {successMessage}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            <div className="space-y-1">
              <label className="font-headline font-black uppercase text-sm">EMAIL</label>
            ...
            <div className="space-y-1 flex flex-col">
              ...
              <input name="password" type="password" className="w-full bg-white border-4 border-black p-3 font-label font-bold text-black focus:outline-none focus:ring-0 focus:border-primary shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-transform focus:translate-y-1 focus:translate-x-1 focus:shadow-none" placeholder="••••••••" required />
            </div>

            <button 
              type="submit" 
              disabled={isLoading}
              className="mt-4 w-full bg-tertiary text-white font-headline font-black text-2xl px-6 py-4 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:bg-[#FFFF00] hover:text-black hover:-translate-x-1 hover:-translate-y-1 transition-all active:translate-x-1 active:translate-y-1 active:shadow-none uppercase italic tracking-tighter cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
