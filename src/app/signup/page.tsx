      ...
      <div className="w-[calc(100%-2rem)] max-w-lg mx-auto bg-surface-dim border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative z-10 flex flex-col mt-8 md:mt-0">
        ...
        <div className="p-6 md:p-8 flex flex-col space-y-6">
          ...
          <form className="flex flex-col space-y-4">
            ...
            <button type="submit" className="w-full bg-secondary text-white font-headline font-black text-2xl px-6 py-4 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:bg-[#FFFF00] hover:text-black hover:-translate-x-1 hover:-translate-y-1 transition-all active:translate-x-1 active:translate-y-1 active:shadow-none uppercase italic tracking-tighter">
              CREATE_ACCOUNT
            </button>
